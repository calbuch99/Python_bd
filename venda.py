...
def inserir_venda(conexao):
    ...
    id_venda = inserir_venda(venda,total_venda)
...
def alimentar_venda(conexao): #Dados 
...
def insert_venda(conexao, id_cliente, data_venda, numero, valor_venda):#Responsável por salvar dados
    cursor = conexao.cursor()
    sql_insert_venda = """
